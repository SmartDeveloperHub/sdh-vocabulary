...
public class UtilsTest {
	...
	public void testResourceURI() throws Exception {
		final URI expected=URI.create("org/smartdeveloperhub/vocabulary/language/lexvo.pack");
		assertThat(Utils.resourceURI(Languages.class,"lexvo.pack"),equalTo(expected));
	}
