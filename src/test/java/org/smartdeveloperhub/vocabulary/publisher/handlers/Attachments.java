...
public final class Attachments {
	...
	private static final AttachmentKey<Module>  MODULE  = AttachmentKey.create(Module.class);
	...
	public static void setModule(final HttpServerExchange exchange, final Module module) {
		exchange.putAttachment(MODULE, module);
	}

	public static Module getModule(final HttpServerExchange exchange) {
		return exchange.getAttachment(MODULE);
	}
